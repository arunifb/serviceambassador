...
public class BarcodeCamera extends AppCompatActivity implements ImageAnalyzer.BarcodeResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        analyzer=new ImageAnalyzer(this,this);
    ...
    void bindPreview(@NonNull ProcessCameraProvider cameraProvider) {
        ...
        new ImageAnalyzer(BarcodeCamera.this, this);
