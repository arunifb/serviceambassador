...
public class DetailsEssentialAdapter extends BaseAdapter  {

    private ArrayList<Details_ess_model> dataSet;
    private ArrayList<Details_ess_model> contactsSetgets;
    Context mContext;
    LayoutInflater layoutInflater;

   // private ContactsFilter contactsFilter;

    public DetailsEssentialAdapter(ArrayList<Details_ess_model> dataSet, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            convertView=layoutInflater.inflate(R.layout.item_details_essentiallist,parent,false);
        ...
        final Details_ess_model dataSets=dataSet.get(position);
