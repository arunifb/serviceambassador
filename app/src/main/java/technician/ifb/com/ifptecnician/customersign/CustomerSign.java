package technician.ifb.com.ifptecnician.customersign;
        ...
        public void onClick(View v) {
            ...
            if (v == mClear) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    ...
                    System.out.println("storage permition");
    ...
    public boolean isStoragePermissionGranted() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (getApplicationContext().checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                ...
                System.out.println("StoragePermission-->"+true);
                view.setDrawingCacheEnabled(true);
                mSignature.save(view, StoredPath);
                // Calling the same class
                recreate();
                ...
                System.out.println("StoragePermission-->"+false);
...
//
//
//                System.out.println("signpaths-->"+byteArray);
//
//                Intent intent = new Intent();
//                intent.putExtra("signpaths", byteArray);
...
//                finish();
            ...
            try {
                ...
                Intent intent = new Intent();
                intent.putExtra("signpath", StoredPath);
                setResult(RESULT_OK, intent);
