package technician.ifb.com.ifptecnician.customspinner;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.search_spinner, null);
        setData(rootView);
    ...
    private void setData(View rootView) {
        ...
        filteritem = (List) getArguments().getSerializable(ITEMS);
...
//                srach_character=charString;
//                if (charString.isEmpty()) {
//                    filteritem = items;
//
//                } else {
//                    //searchString=charString;
//                    List<filteritem> filteredList = new
//                    for (filteritem row : items) {
//
