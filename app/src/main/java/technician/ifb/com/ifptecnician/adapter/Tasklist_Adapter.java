...
public class Tasklist_Adapter extends RecyclerView.Adapter<Tasklist_Adapter.MyViewHolder>
 ...
 implements Filterable{
    ...
    private List<TasklistModel> taskListFiltered;
    ...
    public Tasklist_Adapter(Context context, List<TasklistModel> tasklist, JobsAdapterListener listener,Altclick altclick,Rcnclick rcnclick,Calltocustomer calltocustomer) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final TasklistModel dataSets=taskListFiltered.get(position);
        ...
        public MyViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    final TasklistModel dataSets=taskListFiltered.get(getAdapterPosition());
            ...
            ll_notes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TasklistModel tasklistModel=taskListFiltered.get(getAdapterPosition());
            ...
            iv_alt.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    TasklistModel tasklistModel=taskListFiltered.get(getAdapterPosition());
                    String alt=tasklistModel.getTelePhone();
                    String ref=tasklistModel.getRefId();
                    String ticketno=tasklistModel.getTicketNo();
                    altclick.onAltclick(ref,"",alt,ticketno);
            ...
            iv_calender.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    editor.putString("details",json);
                    editor.commit();
                    context.startActivity(new Intent(context, Create_Appointment.class));
                }
            });
        }
    }
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    //searchString=charString;
                    List<TasklistModel> filteredList = new ArrayList<>();
                    for (TasklistModel row : tasklist) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                taskListFiltered = (ArrayList<TasklistModel>) filterResults.values;
