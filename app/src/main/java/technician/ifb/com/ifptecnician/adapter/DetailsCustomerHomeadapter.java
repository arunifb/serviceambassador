...
public class DetailsCustomerHomeadapter extends BaseAdapter{

    private ArrayList<Details_Home_model> dataSet;

    Context mContext;
    LayoutInflater layoutInflater;


    public DetailsCustomerHomeadapter(ArrayList<Details_Home_model> dataSet, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            convertView=layoutInflater.inflate(R.layout.item_details_customerdetails,parent,false);
        ...
        final Details_Home_model dataSets=dataSet.get(position);
