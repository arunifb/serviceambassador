...
public class SalesAdapter extends RecyclerView.Adapter<SalesAdapter.MyViewHolder> {
    ...
    private ArrayList<AccessoriesModel> dataSet=new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull  final MyViewHolder myViewHolder, int i) {
        final AccessoriesModel dataSets=dataSet.get(i);
        ...
        holder.tv_name.setText(dataSets.getAcc());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if (v==task_cv){
                ...
                final AccessoriesModel dataSets=dataSet.get(getAdapterPosition());
...
//                context.startActivity(new Intent(context,CustomerDetailsActivity.class));
    ...
    public void setListContent(ArrayList<AccessoriesModel> list_task){
