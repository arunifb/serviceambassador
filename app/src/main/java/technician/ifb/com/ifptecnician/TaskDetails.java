...
import technician.ifb.com.ifptecnician.fragment.CustomerFragment;
...
public class TaskDetails extends AppCompatActivity {
    ...
    private int[] tabIcons = {
            R.drawable.user_circle_black_24dp,
            R.drawable.sales_icon,
            R.drawable.stock_black_24dp,
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new CustomerFragment(), "Customer");
        adapter.addFrag(new HomeFragment(), "Spare");
      //  adapter.addFrag(new StockFragment(), "Essential");
