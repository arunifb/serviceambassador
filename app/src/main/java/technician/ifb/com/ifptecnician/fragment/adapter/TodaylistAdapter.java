...
public class TodaylistAdapter extends RecyclerView.Adapter<TodaylistAdapter.MyViewHolder> {
    ...
    private ArrayList<Taskmodel> dataSet=new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull  final MyViewHolder myViewHolder, int i) {
        final Taskmodel dataSets=dataSet.get(i);
...
//            itemView.setOnClickListener(mOnItemClickListener);
        ...
        public void onClick(View v) {
            ...
            if (v==task_cv){
                ...
                final Taskmodel dataSets=dataSet.get(getAdapterPosition());
    ...
    public void setListContent(ArrayList<Taskmodel> list_task){
